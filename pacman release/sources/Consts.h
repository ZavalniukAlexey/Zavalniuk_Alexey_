...
inline const int getPaddingTop()
{
	return 4;
}
inline const int getPaddingSide()
{
	return 1;
}
inline const int getPaddingBot()
{
	return 3;
}
inline const int getMaxSpeed()
{
	return 30;
}
inline const int getWCode()
{
	return 119;
}
inline const int getSCode()
{
	return 115;
}
inline const int getACode()
{
	return 97;
}
inline const int getDCode()
{
	return 100;
}

inline const int getXSize()
{
	return 31;
}
inline const int getYSize()
{
	return 38;
}
inline const int getJumpLine()
{
	return 13;
}
inline const int getBigNumber()
{
	return 1000000;
}
...
inline const int setFieldX()
{
	return 38;
}
inline const int setFieldY()
{
	return 31;
}
